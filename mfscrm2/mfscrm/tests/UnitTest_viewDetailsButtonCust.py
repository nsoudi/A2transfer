...
class ll_ATS(unittest.TestCase):
    ...
    def test_ll(self):
        ...
        time.sleep(10)  # pause to allow screen to load
        ...
        # find 'View details' and click it – note this is all one Python statement
        elem = driver.find_element(By.XPATH, '//*[@id="app-layout"]/div/div/div/div[2]/div/div/div/div/div[1]/div/div/p[2]/a')
        elem.send_keys(Keys.RETURN)
        time.sleep(10)  # pause to allow screen to change
        try:
